...
//
//import (
//	"asset-management/services/asset-api"
//	"context"
//	"database/sql"
//	"fmt"
//)
...
//	Create(tx *main.ScheduleTransaction) (int, error)
//	GetNextMinuteTransactions() ([]main.ScheduleTransaction, error)
...
//func (r *postgresScheduleTransactionRepository) Create(tx *main.ScheduleTransaction) (int, error) {
//	query := `
...
//}
//
//func (r *postgresScheduleTransactionRepository) GetNextMinuteTransactions() ([]main.ScheduleTransaction, error) {
//	rows, err := r.db.Query(`
...
//	}
//
//	var transactions []main.ScheduleTransaction
//	for rows.Next() {
//		var txn main.ScheduleTransaction
